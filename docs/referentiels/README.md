...
Copies de référence des documents officiels KOMPETENCES DECLICK qui gouvernent
la plateforme. **La version Word remise par la direction pédagogique fait foi** ;
ces conversions markdown sont figées ici pour que le code, les revues et les
tests renvoient à un texte versionné dans le dépôt.
