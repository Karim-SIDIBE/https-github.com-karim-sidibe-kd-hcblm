...
const BRAND_THEME = process.env.VITE_BRAND_THEME?.trim() || "#E8650A";
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        display: "standalone",
        start_url: "/",
        // Logo DECLICK DIGITAL (deux « D » entrelacés) sur fond blanc — PNG
        // rendus, pour un rendu identique sur tous les lanceurs.
        icons: [
