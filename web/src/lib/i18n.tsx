...
const fr: Dict = {
  ...
  "ob.validate": "Valider mon pair de progression", "ob.medal": "Entré", "ob.doneTitle": "Introduction terminée !",
  "ob.doneDesc": "Il reste une étape avant votre badge d'entrée : visionnez la vidéo déclencheur du Bloc 0.", "ob.startCourse": "Continuer le parcours →",
  // session
...
const en: Dict = {
  ...
  "ob.validate": "Confirm my progress peer", "ob.medal": "In", "ob.doneTitle": "Introduction completed!",
  "ob.doneDesc": "One step left before your entry badge: watch the Block 0 trigger video.", "ob.startCourse": "Continue the course →",
