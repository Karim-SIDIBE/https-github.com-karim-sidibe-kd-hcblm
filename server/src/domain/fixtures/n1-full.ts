    ...
    // ===================== BLOC 4 — MINI-PROJET CERTIFIANT =====================
    {
      ...
      payload: {
        ...
        sections: [
          ...
          { title: "Micro-session 4.4 — Section 5 — Apprentissage personnel", durationEstimate: "15 min", helpText: "Ce que vous avez compris sur votre relation au temps ; l'obstacle culturel surmonté ou contourné ; les 3 prochaines occasions de reprendre le contrôle ; ce que vous diriez à un pair qui commence ce parcours demain ; une difficulté concrète rencontrée pendant les 15 jours de pratique et ce qu'elle vous a appris ; une croyance sur le temps que vous avez révisée — ou une chose qui n'a pas fonctionné et ce que vous ferez différemment.", prefillFromMomentAncrage: false },
        ],
        journal: {
          ...
          entries: [
            ...
            { day: 11, prompt: "En repartant de {{moment_ancrage}}, quelle est la micro-victoire de productivité la plus significative de ces 10 premiers jours ? Soyez précis et concret. Situez aussi votre charge de travail du moment : si vous avez repéré un signal de surcharge ou de décrochage, dites lequel et l'ajustement concret que vous avez fait.", minWords: 50, placeholder: "ex. Vendredi, j'ai rendu le rapport avec un jour d'avance grâce à mes deux plages protégées. Semaine chargée : fatigue sentie mercredi, j'ai déplacé ma plage au matin…" },
