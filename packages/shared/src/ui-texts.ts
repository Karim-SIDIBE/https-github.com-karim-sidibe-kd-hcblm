...
const fr: UiDict = {
  ...
  "ob.how5": "🎓 La certification : un mini-projet ancré dans votre réalité, évalué par un évaluateur humain avec une grille transparente (seuil 70/100).",
  ...
  "pj.sectionLocked": "🔒 S'ouvre après les sections 1 à 3 et les 6 micro-entrées du journal.",
...
const en: UiDict = {
  ...
  "ob.how5": "🎓 Certification: a mini-project anchored in your reality, assessed by a human evaluator with a transparent rubric (70/100 threshold).",
